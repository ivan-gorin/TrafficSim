...
namespace CityFlow {
    ...
    Engine::Engine(const std::string &configFile, int threadNum, mainView* inView) : threadNum(threadNum), startBarrier(threadNum + 1),
                                                                   endBarrier(threadNum + 1), view(inView) {
